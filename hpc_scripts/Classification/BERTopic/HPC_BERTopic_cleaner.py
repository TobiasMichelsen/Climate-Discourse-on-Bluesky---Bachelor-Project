...
min_cluster_sizes = [500]     # Try smaller than 500 now
min_samples_vals = [200]     # Decreasing increases sensitivity
distance_metrics = ["cosine"]

#HYPERPARAMETERS: UMAP

umap_neighbors = [15]        # Local focus
umap_components = [7]        # Lower = more compression
