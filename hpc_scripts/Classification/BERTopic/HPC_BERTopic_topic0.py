...
#DATA
input_path = "oldLogs"
filename = "all-MiniLM-L6-v2_cosine_c500_s200_nt18_u15-7-0.01/topics_before_reduction.json"
...
min_cluster_sizes = [100, 200]     # Try smaller than 500 now
min_samples_vals = [5, 20, 50]     # Decreasing increases sensitivity
distance_metrics = ["cosine"]

#HYPERPARAMETERS: UMAP

umap_neighbors = [5, 10]        # Local focus
umap_components = [5, 7]        # Lower = more compression
umap_min_dist = [0.0, 0.01]     # Tight clusters
