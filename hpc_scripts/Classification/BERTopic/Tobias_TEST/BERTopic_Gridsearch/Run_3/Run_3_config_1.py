...
#Combinations: 32: Low granularity
...
# --- Logging Setup ---
log_path = os.path.expanduser("run3/logs/bertopic_grid_log_3_1.csv")
...
for embed_model in embedding_models:
    ...
    for (min_cluster_size, min_samples, metric,
        ...
        try:
            ...
            df_result.to_json("run3/logs/clusters_run3_1.json", orient="records", lines=True)
