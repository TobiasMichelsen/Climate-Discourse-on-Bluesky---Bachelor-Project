...
#Combinations: 32: Medium Granularity

embedding_models = ["all-MiniLM-L6-v2"]
min_cluster_sizes = [50,75]
min_samples_vals = [10,20]
distance_metrics = ["cosine"]
umap_neighbors = [10,15]
umap_components = [5,11]
...
# --- Logging Setup ---
log_path = os.path.expanduser("run3/logs/bertopic_grid_log_3_2.csv")
...
for embed_model in embedding_models:
    ...
    for (min_cluster_size, min_samples, metric,
        ...
        try:
            ...
            df_result.to_json("run2/logs/clusters_run3_2.json", orient="records", lines=True)
