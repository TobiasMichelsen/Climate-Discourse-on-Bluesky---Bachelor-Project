...
#Combinations: 32, high gran, two embeds

embedding_models = ["all-MiniLM-L6-v2","paraphrase-MiniLM-L6-v2"]
min_cluster_sizes = [20,40]
min_samples_vals = [6,8]
distance_metrics = ["cosine"]
umap_neighbors = [7,9]
umap_components = [7,11]
umap_min_dist = [0.0]
nr_topics = 15
...
# --- Logging Setup ---
log_path = os.path.expanduser("run3/logs/bertopic_grid_log_3_5.csv")
...
for embed_model in embedding_models:
    ...
    for (min_cluster_size, min_samples, metric,
        ...
        try:
            ...
            df_result.to_json("run3/logs/clusters_run3_5.json", orient="records", lines=True)
