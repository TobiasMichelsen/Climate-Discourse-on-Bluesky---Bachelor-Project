...
# --- Logging Setup ---
log_path = os.path.expanduser("run2/logs/bertopic_grid_log_fast.csv")
...
for embed_model in embedding_models:
    ...
    for (min_cluster_size, min_samples, metric,
        ...
        try:
            ...
            df_result.to_json("run2/logs/clusters_run2.json", orient="records", lines=True)
