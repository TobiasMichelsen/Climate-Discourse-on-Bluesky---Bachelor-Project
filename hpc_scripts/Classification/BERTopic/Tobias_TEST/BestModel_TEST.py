...
# BEST MODEL: "all-MiniLM-L6-v2,cosine,50,10,15,15,5,0.0,14,98736,43.25,1989.2,0.5798575788402855,0.8148340248962653,0.8021086780210869,0.7182983770988377"

# --- HYPERPARAMETERS ---
embedding_models = ["all-MiniLM-L6-v2"]

min_cluster_sizes = [50]
min_samples_vals = [10]
...
log_path = os.path.expanduser("logs/bertopic_grid_log_Large.csv")
