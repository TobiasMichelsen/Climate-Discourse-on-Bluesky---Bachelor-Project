...
input_path = "../data/run2_results"
filename = "run2_result_clean_cid.json"
...
save_path = "../data/run3_results"
os.makedirs(save_path, exist_ok=True)
print(f"Saved BERTopic model to: {save_path}")
df_result.to_json(os.path.join(save_path, "run3_result.json"), orient= "records", lines=True)
